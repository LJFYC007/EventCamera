...
m.frameCapture.outputDir = "$DIRECTORY$\\image"
m.frameCapture.baseFilename = "Mogwai"
frames_to_capture = list(range($ACCUMULATE_PASS$, $EXIT_FRAME$ + 1, $ACCUMULATE_PASS$))
m.frameCapture.addFrames(m.activeGraph, frames_to_capture)
